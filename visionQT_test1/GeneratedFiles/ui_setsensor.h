/********************************************************************************
** Form generated from reading UI file 'setsensor.ui'
**
...
#ifndef UI_SETSENSOR_H
#define UI_SETSENSOR_H
...
"    border-radius: 2px;\n"
"}"));
        INT_radioButton = new QRadioButton(Trigger_groupBox);
        INT_radioButton->setObjectName(QStringLiteral("INT_radioButton"));
        INT_radioButton->setGeometry(QRect(10, 30, 41, 16));
        HW_radioButton = new QRadioButton(Trigger_groupBox);
        HW_radioButton->setObjectName(QStringLiteral("HW_radioButton"));
        HW_radioButton->setGeometry(QRect(90, 30, 41, 16));
        Encode_radioButton = new QRadioButton(Trigger_groupBox);
        Encode_radioButton->setObjectName(QStringLiteral("Encode_radioButton"));
        Encode_radioButton->setGeometry(QRect(170, 30, 71, 16));
...
"}"));
    ...
    void retranslateUi(QWidget *SetSensor)
    {
        ...
        INT_radioButton->setText(QApplication::translate("SetSensor", "INT", 0));
...
namespace Ui {
    class SetSensor: public Ui_SetSensor {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_SETSENSOR_H
